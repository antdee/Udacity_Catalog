...
def fbconnect():
    ...
    app_id = json.loads(open('/var/www/Udacity_Catalog/Udacity_Catalog/fb_client_secrets.json', 'r').read())[
        'web']['app_id']
    app_secret = json.loads(
        open('/var/www/Udacity_Catalog/Udacity_Catalog/fb_client_secrets.json', 'r').read())['web']['app_secret']
...
def gconnect():
    ...
    try:
        ...
        oauth_flow = flow_from_clientsecrets('/var/www/Udacity_Catalog/Udacity_Catalog/client_secrets.json', scope='')
